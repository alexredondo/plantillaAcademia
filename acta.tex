...
\usepackage[utf8]{inputenc} % tíldes
\usepackage{geometry} %estructura
 \geometry{
headheight=20mm,
voffset=5mm,
 }
...
\usepackage{fancyhdr} %head % food
\usepackage{lastpage} % # páginas
...
\renewcommand{\headrulewidth}{0pt} %línea separadora head
\renewcommand{\footrulewidth}{1pt} %línea separadora foot
...
\chead{
        ...
        \end{tabular}
         ...
         \hline
         Proceso: Consejo Académico & Acta No. 08-0118 \\ 
         \hline
        \end{tabular}
 }
%\end{center}
%\chead{academia.net.co}
%\rchead{ %\begin{center}}
...
\def \acta {ACTA No. 08-0118 CONSEJO ACADÉMICO} %Variable
...
\textbf{Asistentes:} \input{miembrosCAcad.tex}.\\
